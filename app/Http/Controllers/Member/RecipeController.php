...
class RecipeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('member.recipe.create', compact('categories'));
    }
    ...
    {
        return view('member.recipe.show', compact('recipe')); 
    }
    ...
    {
        $categories = Category::all();
        return view('member.recipe.edit', compact('recipe', 'categories'));
    }
